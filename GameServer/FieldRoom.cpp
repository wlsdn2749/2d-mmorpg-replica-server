...
void FieldRoom::OnEnterSetSpawn(const PlayerRef& p)
{
	p->posX = SpawnX();
	p->posY = SpawnY();
}
...
void FieldRoom::SendWorldSnapShotTo(const PlayerRef& p)
{
...
void FieldRoom::BroadcastEnter(const PlayerRef& newcomer)
{
...
void FieldRoom::BroadcastLeave(const PlayerRef& leaver)
{
